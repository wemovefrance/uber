...
<p style="color:black"> Bonjour <c:out value="${conducteur.prenom}" /> </p>
<p>  </p>
...
<p><a href="drivergestionvehicule"><i class="fa fa-car fa-3x" style="color:#26a69a"></i><i class="fa fa-plus fa-2x" style="color:#26a69a"></i></a></p>
