...
<form:select style="display:block" name="forfaitKilomètre" id="forfaitKilometre" path="distance" >
  <form:option value = "30.0">0 - 50 km  - 30€ </form:option>
  <form:option value = "50.0">50 - 100 km - 50 €</form:option>
  <form:option value = "70.0">100 - 150 km - 70 €</form:option>
  <form:option value = "150.0">Plus de  150 km - 150 €</form:option>
</form:select>
