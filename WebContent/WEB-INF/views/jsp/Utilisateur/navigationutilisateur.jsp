  ...
  <nav class="white">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="/frWeMove/accueil/quisommesnous"> Qui
					sommes-nous ? </a></li>
        <li><a href="/frWeMove/accueil/faq"> FAQ </a></li> -->
        <li><a href="monprofil"><i class="fa fa-home fa-2x" style="color:#26a69a"></i></a></li>
      ...
      <ul class="side-nav" id="mobile-demo">
        ...
        <li><a href="/frWeMove/accueil/quisommesnous"> Qui
					sommes-nous ? </a></li>
        <li><a href="/frWeMove/accueil/faq"> FAQ </a></li> -->
        <li><a href="monprofil"><i class="fa fa-home fa-2x" style="color:#26a69a"></i> Accueil</a></li>
